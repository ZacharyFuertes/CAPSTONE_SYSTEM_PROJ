    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-[#0a0a0a] rounded-none border border-[#222] border-t-2 border-t-[#d63a2f] w-full sm:max-w-[1100px] h-[95vh] sm:h-auto sm:max-h-[94vh] overflow-hidden shadow-2xl flex flex-col"
        >
          {/* Header */}
          ...
          <div
            id="receipt-content"
            className="flex-1 overflow-y-auto px-6 sm:px-10 py-8 bg-[#0a0a0a]"
          >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8 pb-8 border-b border-[#222]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <Wrench
                      size={20}
                      className="text-[#d63a2f] mt-1 flex-shrink-0"
                    />
                    <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <Calendar
                      size={20}
                      className="text-[#4ade80] mt-1 flex-shrink-0"
                    />
                    <div>
                      <p className="text-[10px] text-[#6b6b6b] uppercase tracking-widest font-bold mb-1">
                        Appointment Date
          ...
          {/* Footer Actions */}
          <div className="px-6 sm:px-10 py-6 border-t border-[#222] bg-[#111] flex-shrink-0 flex gap-3">
            <button
              onClick={onClose}
              className="flex-1 py-3 px-4 bg-[#d63a2f] hover:bg-[#c0322a] text-white border border-[#d63a2f] font-bold uppercase tracking-widest transition"
            >
              CLOSE
            </button>
          </div>
