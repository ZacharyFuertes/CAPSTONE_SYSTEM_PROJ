...
const HeroSlideshow: React.FC<HeroSlideshowProps> = ({
  ...
  const slides: Slide[] = [
    ...
    },
    {
      id: 4,
      image:
        "https://images.pexels.com/photos/10182878/pexels-photo-10182878.jpeg",
      title: "Built To Last",
