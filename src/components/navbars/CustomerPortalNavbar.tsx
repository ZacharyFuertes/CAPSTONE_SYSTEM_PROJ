...
import { Menu, X, Globe, LogOut, Package, Calendar, Users } from "lucide-react";
...
const CustomerPortalNavbar: React.FC<CustomerPortalNavbarProps> = ({
  ...
  const menuItems = [
    {
      ...
      icon: Calendar,
      tooltip: "View your appointments",
    },
    {
      id: "browse-parts",
      label: "Browse Parts",
      icon: Package,
      tooltip: "Browse available parts",
    },
    {
      id: "customer-portal",
      label: "My Profile",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            <div>
              <h1 className="text-xl font-bold text-white">JBMS MotoShop</h1>
