...
import { Menu, X, Globe, LogOut, LucideIcon } from "lucide-react";
import { useAuth } from "../../contexts/AuthContext";
import { useLanguage } from "../../contexts/LanguageContext";

export interface GenericNavbarMenuItem {
  id: string;
  label: string;
  icon: LucideIcon;
  tooltip?: string;
...
interface GenericNavbarProps {
  subtitle: string;
  currentPage?: string;
  menuItems: GenericNavbarMenuItem[];
  onNavigate: (page: string) => void;
  onLogo?: () => void;
  logoLabel?: string;
  userRole?: "owner" | "mechanic" | "customer" | "admin";
}
