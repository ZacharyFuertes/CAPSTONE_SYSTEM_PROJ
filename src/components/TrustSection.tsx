...
const TrustSection: React.FC = () => {
  ...
  return (
    <section
      id="about"
      className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-moto-dark to-moto-darker relative overflow-hidden"
    >
      {/* Background Effects */}
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Makikita kung ano ang sinasabi ng mga rider mula sa buong
              Pilipinas tungkol sa MotoShop
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, idx) => (
              <motion.div
                ...
                whileHover={{
                  y: -4,
                  boxShadow: "0 20px 40px rgba(230, 57, 70, 0.1)",
                }}
              >
                {/* Rating */}
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 mb-6 max-w-md mx-auto">
              Get exclusive deals, new product launches, and expert motorcycle
              tips delivered to your inbox
            </p>

            <form onSubmit={handleSubscribe} className="flex max-w-md mx-auto relative z-10 mb-4">
              <input
                type="email"
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                placeholder="Enter your email"
                className="flex-1 bg-white/10 text-white placeholder:text-white/50 px-6 py-4 rounded-l-xl border-y border-l border-white/20 focus:outline-none focus:border-white/40"
              />
              <button
                type="submit"
                className="bg-white text-[#d63a2f] px-6 py-4 rounded-r-xl font-bold flex items-center justify-center hover:bg-white/90 transition-colors"
                title="Subscribe"
              >
                <Send size={20} />
              </button>
